	...
	<div>
		<div class="ReportDetail-flow">
			<p class="ReportDetail-flow-title">
				<van-icon name="cameraenhance" color="rgb(159, 165, 184)" class="ReportDetail-flow-title-icon" />
				<span class="ReportDetail-flow-title-p2">现场确认</span>
			</p>
			<div class="ReportDetail-Nextquestion">
				<p class="ReportDetail-Nextquestion-content" v-html="PlanDepartQuestionsData.data.confirm_text"></p>
				<van-row class="ReportDetail-Nextquestion-row">
					<van-col span="20" class="ReportDetail-Nextquestion-row-col">
						...
						<span class="ReportDetail-Nextquestion-row-col-span">最近编辑：{{PlanDepartQuestionsData.data.confirm_at}}</span>
					</van-col>
					<van-col span="4" class="ReportDetail-Nextquestion-row-col right_text" @click.native="EditField" v-if="is_audit != 'true'">
