					...
					<van-row class="HangAir-row-wen-van">
						<van-col span="5" class="HangAir-row-wen-van-col">
							<div class="HangAir-row-wen-van-col-center">
								<van-icon name="exclamation" class="HangAir-row-wen-van-col-redwen iconBe" />
							</div>
						</van-col>
						<van-col span="17" class="HangAir-row-wen-van-col">
							<p class="HangAir-row-wen-van-col-p1">报告结果已驳回</p>
							<p class="HangAir-row-wen-van-col-p2">查看驳回原因</p>
						</van-col>
